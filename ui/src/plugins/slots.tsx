 ...
 *
 * Plugin bundles are built with `external: ["@stapler/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@stapler/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@stapler/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@stapler/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@stapler/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@stapler/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@stapler/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
