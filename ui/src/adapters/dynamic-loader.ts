 ...
 *
 * When the Stapler UI encounters an adapter type that doesn't have a
 ...
 * runtime dependencies, and Stapler's UI loads it on demand.
 */

import type { TranscriptEntry } from "@stapler/adapter-utils";
