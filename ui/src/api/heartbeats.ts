import type { HeartbeatRun, HeartbeatRunEvent, InstanceSchedulerHeartbeatAgent, WorkspaceOperation } from "@stapler/shared";
...
export const heartbeatsApi = {
  ...
  review: (runId: string, action: "approve" | "reject") =>
    api.post<{ id: string; status: string }>(`/heartbeat-runs/${runId}/review`, { action }),
