...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@stapler/shared";
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @stapler/ui typecheck", "pnpm build-storybook"],
