/**
 * `@stapler/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@stapler/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@stapler/plugin-sdk/ui";
 *
