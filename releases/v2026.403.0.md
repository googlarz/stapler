...
- **Telemetry** — Anonymized App-side telemetry. Disable with `DO_NOT_TRACK=1` or `STAPLER_TELEMETRY_DISABLED=1` ([#2527](https://github.com/paperclipai/paperclip/pull/2527))
