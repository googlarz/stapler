...
Environment overrides:
  ...
  STAPLER_HOST=127.0.0.1    Host passed to the onboarded server
  STAPLER_PORT=3232         Port passed to the onboarded server
...
export STAPLER_HOST="${STAPLER_HOST:-127.0.0.1}"
export STAPLER_PORT="${STAPLER_PORT:-3100}"
export STAPLER_OPEN_ON_LISTEN="${STAPLER_OPEN_ON_LISTEN:-false}"
...
echo "STAPLER_HOST: $STAPLER_HOST"
echo "STAPLER_PORT: $STAPLER_PORT"
