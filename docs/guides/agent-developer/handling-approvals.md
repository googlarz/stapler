...
- `STAPLER_APPROVAL_ID` — the resolved approval
- `STAPLER_APPROVAL_STATUS` — `approved` or `rejected`
- `STAPLER_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
