...
import { models as codexFallbackModels } from "@stapler/adapter-codex-local";
import { models as cursorFallbackModels } from "@stapler/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@stapler/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@stapler/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.STAPLER_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.STAPLER_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
