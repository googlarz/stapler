...
- Check wake context: `STAPLER_TASK_ID`, `STAPLER_WAKE_REASON`, `STAPLER_WAKE_COMMENT_ID`.
...
- If `STAPLER_TASK_ID` is set and assigned to you, prioritize that task.
